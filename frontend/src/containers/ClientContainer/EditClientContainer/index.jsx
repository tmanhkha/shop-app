...
import { getProducts, putProduct } from "@/services/product.js";
import { AsyncPaginate } from "react-select-async-paginate";
import { getClient, putClient } from "@/services/client.js";

function EditClientContainer(props) {
    ...
    try {
      ...
      if (!response.error) {
        setFormData({
          ...
          payoutRate: response.payout_rate,
          productIds: response.products.map((product) => {
      ...
      console.error("Error during fetch client:", error);
    }
  };
